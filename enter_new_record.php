...
<form id="book" method="post" autocomplete="off">
  ...
  <label for="media1"> Book, TV, or film name </label>
	<input type="text" name="media1" id="media1" maxlength="100" required>

  <label for="media2">Which type of media is the recommendation? </label>
  <select name="media2" id="media2" required>
      <option value=""></option>
